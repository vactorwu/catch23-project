...
util.multiSelect.MultiSelect = Ext.extend(Ext.form.Field,  {
    ...
    initComponent: function(){
        util.multiSelect.MultiSelect.superclass.initComponent.call(this);
    ...
    onRender: function(ct, position){
        util.multiSelect.MultiSelect.superclass.onRender.call(this, ct, position);
        ...
        if(this.flag == "tree"){
        	fs.add(this.store);
        	this.store.on('click', this.onTreeClick, this);
        	this.store.on('expandnode',this.onTreeExpand,this);
        	this.store.on('load',this.onTreeRender,this);
        	this.store.on('insert',this.onNodeExpand,this);
        	this.store.on('append',this.onNodeExpand,this);
        }else{
        	fs.add(this.view);
    ...
    afterRender: function(){
        util.multiSelect.MultiSelect.superclass.afterRender.call(this);
        ...
        if (this.draggable || this.dragGroup){
            this.dragZone = new util.multiSelect.MultiSelect.DragZone(this, {
                ddGroup: this.dragGroup
            });
        }
        if (this.droppable || this.dropGroup){
            this.dropZone = new util.multiSelect.MultiSelect.DropZone(this, {
    ...
    onTreeExpand: function(node){
    	return this.fireEvent('click',node)
    },
    
    onNodeExpand: function(tree,parent,node){
    	return this.fireEvent('expand',tree,parent,node)
    },
    
    onTreeRender: function(node){
    	return this.fireEvent('load',node)
    },
    // private
    ...
    destroy: function(){
        ...
        util.multiSelect.MultiSelect.superclass.destroy.call(this);
    }
});


Ext.reg('multiselect', util.multiSelect.MultiSelect);

//backwards compat
Ext.ux.Multiselect = util.multiSelect.MultiSelect;


util.multiSelect.MultiSelect.DragZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    ...
    util.multiSelect.MultiSelect.DragZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDraggable(ddGroup);
};

Ext.extend(util.multiSelect.MultiSelect.DragZone, Ext.dd.DragZone, {
...
util.multiSelect.MultiSelect.DropZone = function(ms, config){
    this.ms = ms;
    this.view = ms.view;
    var ddGroup = config.ddGroup || 'MultiselectDD';
    var dd;
    ...
    util.multiSelect.MultiSelect.DropZone.superclass.constructor.call(this, this.ms.fs.body, { containerScroll: true, ddGroup: dd });
    this.setDroppable(ddGroup);
};

Ext.extend(util.multiSelect.MultiSelect.DropZone, Ext.dd.DropZone, {
    /**
