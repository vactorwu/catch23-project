$PBExportHeader$fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices.sru
forward
global type fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices from nonvisualobject
end type
end forward

global type fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices from nonvisualobject
end type
global fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices
...
on fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices.create
call super::create
...
event constructor;
    ...
    d_endpoint.URL = "net.tcp://kesser/TradeServiceWcf/TradeServiceWcf.svc"
    wcfConnectionObject.EndpointAddress = d_endpoint

    // Timeout
    wcfConnectionObject.Timeout = "00:10:00"
    // BindingType
    wcfConnectionObject.BindingType = PBWCF.WCFBindingType.NetTcpBinding!
    // Binding
    PBWCF.WCFnetTcpBinding d_binding
    d_binding= Create PBWCF.WCFnetTcpBinding

    d_binding.TransferMode = PBWCF.WSTransferMode.BUFFERED!
    d_binding.TransactionProtocol = PBWCF.TransactionProtocolType.OLETRANSACTIONS!
    ...
    d_binding.MaxConnections  = 10
    d_binding.ListenBackLog  = 10
    ...
    // Security
    d_binding.Security = Create PBWCF.NetTcpSecurity
    d_binding.Security.SecurityMode = PBWCF.wsSecurityMode.NONE!

    wcfConnectionObject.netTcpBinding = d_binding


    m_service.setConnectionOption(wcfConnectionObject)
end event

on fundtraderproxy_TradeServicesClient_CustomBinding_ITradeServices.destroy
