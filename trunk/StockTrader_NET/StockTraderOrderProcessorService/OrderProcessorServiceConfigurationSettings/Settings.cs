...
//======================================================================================================
// The Settings class for the Order Processor Service.  Please note well that we only override the
// inherited settings (with the new keyword) becuase of the special case StockTrader allows for running
// OPS in-process with the Business Service layer, vs. remote.  You will NOT need to do this for your
// services--your Settings class will be much simpler, simply using the *inherited* global settings, and only
// specifying app-specific settings here.  
//======================================================================================================
...
namespace Trade.OrderProcessorServiceConfigurationSettings
{
    /// <summary>
    ...
    /// ORDER PROCESSOR AND OTHER STOCKTRADER 5 COMPONENTS ARE SPECIAL in that they can collapse down to run within the calling service process.
    ...
    public class Settings : ConfigurationSettingsBase   //Inherit but override from base implementation!!
    {
        ...
        //End configuration database Settings -----------------------------------
        ...
        //BEGIN ORDER PROCESSOR SERVCIE (OPS) REPOSITORY DEFINED SETTINGS.  ANY CONFIG KEY SETTING DEFINED IN DB REPOSITORY MUST HAVE A MATCHING STATIC VARIABLE HERE.
        ...
        public static int MaxQueueBatchSize;
        ...
        //Used by TraderOrderHost and set on app startup as config options.
        public static bool NOPOISONQUEUE = false;
        public static bool NOMSMQ = false;
        public static string QUENAMEPOISON = "";
        ...
        //You can of course also add any constants or statics in this class as well, not initialized from
        //repository but just initialized here in code.
