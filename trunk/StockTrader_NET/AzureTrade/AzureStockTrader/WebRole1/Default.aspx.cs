    ...
    public partial class _Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (ConfigUtility.onAzure)
                HyperLinkConfigWeb.NavigateUrl = "https://azureconfigweb.cloudapp.net/";
            else
                HyperLinkConfigWeb.NavigateUrl = "http://" + HttpContext.Current.Server.MachineName + "/" + Settings.PAGE_PATH_CONFIG;
        }
    }
}
