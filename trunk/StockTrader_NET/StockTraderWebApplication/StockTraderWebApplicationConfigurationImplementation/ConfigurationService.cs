...
//======================================================================================================
// The Web app's ConfigurationService implementation class.  Note the StockTrader Web app only has to override 
// methods based on the fact it can run the BSL in a special in-process mode.
// Typically, no overrides are needed, base class will work fine. So no further implementation logic/work is needed for typical
// apps implementing the Configuration Service; this logic is 'special'.
//======================================================================================================
        ...
        public override List<TraverseNode> getTraversePath(List<TraverseNode> queriedNodeList, string targetHostNameIdentifier, string targetConfigServiceNameIdentifier, ServiceUsers csUser)
        {
            switch (Trade.StockTraderWebApplicationSettings.Settings.ACCESS_MODE)
            {
                case StockTraderUtility.BSL_INPROCESS:
                    {
                        if (targetHostNameIdentifier.Equals(StockTraderUtility.IISHOST_BUSINESS_SERVICES))
                        {
                    ...
                    for (int i = 0; i < returnConnectionPoints.MyConnectionPoints.Count; i++)
                    {
                        switch (Trade.StockTraderWebApplicationSettings.Settings.ACCESS_MODE)
                        {
                            ...
                            case StockTraderUtility.BSL_AZURE_TCP_TMSEC_CLIENTCERT:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_AZURE_TCP_TMSEC_CLIENTCERT))
                            ...
                            case StockTraderUtility.BSL_AZURE_TCP_TMSEC_USERNAME:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_AZURE_TCP_TMSEC_USERNAME))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_AZURE_WSHTTP_TMSEC_CLIENTCERT:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_AZURE_WSHTTP_TMSEC_CLIENTCERT))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_AZURE_WSHTTP_TMSEC_USERNAME:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_AZURE_WSHTTP_TMSEC_USERNAME))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_IISHOST_BSL_HTTP:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_BSL_HTTP))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_IISHOST_BSL_TCP:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_BSL_TCP))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_IISHOST_TCP_TMSEC_CLIENTCERT:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_TCP_TMSEC_CLIENTCERT))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_IISHOST_TCP_TMSEC_USERNAME:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_TCP_TMSEC_USERNAME))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_IISHOST_WSHTTP_MSEC_CLIENTCERT:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_WSHTTP_MSEC_CLIENTCERT))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            case StockTraderUtility.BSL_IISHOST_WSHTTP_TMSEC_CLIENTCERT:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_WSHTTP_TMSEC_CLIENTCERT))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            ...
                            case StockTraderUtility.BSL_IISHOST_WSHTTP_TMSEC_USERNAME:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_IISHOST_WSHTTP_TMSEC_USERNAME))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            case StockTraderUtility.BSL_SELFHOST_HTTP:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_SELFHOST_HTTP))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            case StockTraderUtility.BSL_SELFHOST_TCP:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_SELFHOST_TCP))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                            case StockTraderUtility.BSL_SELFHOST_TCP_TMSEC_CLIENTCERT:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_SELFHOST_TCP_TMSEC_CLIENTCERT))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }

                            case StockTraderUtility.BSL_SELFHOST_TCP_TMSEC_USERNAME:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_SELFHOST_TCP_TMSEC_USERNAME))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }

                            case StockTraderUtility.BSL_SOAP:
                                {
                                    if (returnConnectionPoints.MyConnectionPoints[i].ServiceFriendlyName.Equals(StockTraderUtility.BSL_SOAP))
                                        returnConnectionPoints.MyConnectionPoints[i].InUse = true;
                                    break;
                                }
                        }
