...
namespace Trade.Utility
{
    ...
    public static class StockTraderUtility
    {
        ...
        public const string EXPRESSION_HOLDINGID = "^[0-9'\\s]{1,9}$";
        ...
        public const string ORDER_PROCESSOR_SERVICE_SELFHOST = ".NET StockTrader Order Processor Service";
        public const string ORDER_PROCESSOR_SERVICE_AZURE = "Azure StockTrader Order Processor Service";
        public const string ORDER_PROCESSOR_SERVICE_SOAP = "SOAP StockTrader Order Processor Service";
        ...
        public static string WEB_APPLICATION = ".NET StockTrader Web Application";
        public static string WEB_APPLICATION_Azure = "Azure StockTrader Web Application";
        ...
        public const string IISHOST_BUSINESS_SERVICES = ".NET StockTrader Business Services IIS Host";
        public const string SELF_HOSTBUSINESS_SERVICES = ".NET StockTrader Business Services Self Host";
        public const string SOAP_BUSINESS_SERVICES = "Basic SOAP Business Services";
        ...
        public const string BSL_AZURE_WSHTTP_TMSEC_USERNAME = "Azure BSL wsHttp security = TransportWithMessageCredential: UserName";
        ...
        public const string BSL_AZURE_TCP_TMSEC_USERNAME = "Azure BSL netTcp security = TransportWithMessageCredential: UserName";
        public const string BSL_SELFHOST_HTTP = "On-Premise Self-Host BSL http";
        public const string BSL_SELFHOST_TCP = "On-Premise Self-Host BSL netTcp";
        public const string BSL_SELFHOST_TCP_TMSEC_CLIENTCERT = "On-Premise Self-Host BSL netTcp security = TransportWithMessageCredential: ClientCertificate";
        public const string BSL_SELFHOST_TCP_TMSEC_USERNAME = "On-Premise Self-Host BSL netTcp security = TransportWithMessageCredential: UserName";
        public const string BSL_SELFHOST_WSHTTP_TMSEC_CLIENTCERT = "On-Premise Self-Host BSL wsHttp security = TransportWithMessageCredential: ClientCertificate";
        public const string BSL_SELFHOST_WSHTTP_TMSEC_USERNAME = "On-Premise Self-Host BSL wsHttp security = TransportWithMessageCredential: UserName";
        public const string BSL_IISHOST_TCP_TMSEC_CLIENTCERT = "On-Premise IIS Host BSL netTcp security = TransportWithMessageCredential: ClientCertificate";
        public const string BSL_IISHOST_TCP_TMSEC_USERNAME = "On-Premise IIS Host BSL netTcp security = TransportWithMessageCredential: UserName";
        public const string BSL_IISHOST_WSHTTP_MSEC_CLIENTCERT = "On-Premise IIS Host BSL wsHttp security = Message with ClientCredential: ClientCertificate";
        public const string BSL_IISHOST_WSHTTP_TMSEC_USERNAME = "On-Premise IIS Host BSL wsHttp security = TransportWithMessageCredential: UserName";
        public const string BSL_IISHOST_WSHTTP_TMSEC_CLIENTCERT = "On-Premise IIS Host BSL wsHttp security = TransportWithMessageCredential: ClientCertificate";
        public const string BSL_IISHOST_BSL_HTTP = "On-Premise IIS Host BSL Basic Http SOAP";
        public const string BSL_IISHOST_BSL_TCP = "On-Premise IIS Host BSL netTcp";
        public const string BSL_SOAP = "Interop: Basic Http SOAP BSL";
        ...
        public const string OPS_SELF_HOST_TCP_TMSEC_CLIENTCERT = "On-Premise Self-Host OPS netTcp security = TransportWithMessageCredential: ClientCertificate";
        public const string OPS_SELF_HOST_TCP_TMSEC_USERNAME = "On-Premise Self-Host OPS netTcp security = TransportWithMessageCredential: ClientUserName";
        public const string OPS_SELF_HOST_HTTP_TMSEC_CLIENTCERT = "On-Premise Self-Host OPS wsHttp security = TransportWithMessageCredential: ClientCertificate";
        public const string OPS_SELF_HOST_HTTP_TMSEC_USERNAME = "On-Premise Self-Host OPS wsHttp security = TransportWithMessageCredential: ClientUserName";
        public const string OPS_SELF_HOST_TCP = "On-Premise Self-Host OPS netTcp";
        public const string OPS_SELF_HOST_HTTP = "On-Premise Self-Host OPS http";
        public const string OPS_SELF_HOST_MSMQ = "On-Premise Self-Host OPS MSMQ Transacted Queue";
        public const string OPS_SOAP = "Interop: Basic Http SOAP OPS";
