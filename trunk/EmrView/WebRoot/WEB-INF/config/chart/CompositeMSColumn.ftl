...
<chart caption="${title}" animation="1"  showLegend="1" legendScrollBtnColor='cccccc' legendScrollBarColor='eeeeee' canvasBorderThickness="1" canvasBorderAlpha="60" showBorder="0" subcaption="${subTitle}"  numVDivLines='10' useRoundEdges='0' use3DLighting="1" showLegend='0' maxColWidth="30" numberScaleValue="10000,10000" numberScaleUnit="万,亿" labelDisplay="Stagger"  yAxisName='' showValues='1' legendPosition="RIGHT" >
	<categories>
	<#list rs as r>
		<#if r_index = limit>
			<#break>
