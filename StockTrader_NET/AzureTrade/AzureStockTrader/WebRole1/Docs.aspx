...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <h2>
        ...
        <td width="900px">
        <p>
        StockTrader 5.0 is an end-to-end sample application with a variety of different 
        ...
        will show up as a C# project type.  Besides providing a turnkey implementation of the Configuration Service, it provides a UI 
            Layer,
        Business Service Layer (BSL), and Data Access Layer (DAL) ala StockTrader 5.0.  The wizard lets you select your host environment, including on-premise or Azure projects, so you
        should check this out.  Of course, the StockTrader 5.0 application demonstrates just one of several enterprise design patterns possible, in this case a multi-tier application
        ...
        <ul>
        <li>
        <a href="documentation/GuideToSolutions.pdf" target="_blank">Guide to Visual Studio Solutions</a>
        </li>
         <li>
        <a href="documentation/Trade5Overview.pdf" target="_blank">StockTrader 5.0 Technical Overview</a>
        </li>
         <li>
        <a href="documentation/StockTraderOverview.ppsx" target="_blank">StockTrader 5.0 SlideShow</a>
        </li>
        <li>
        <a href="documentation/stocktraderconfiguration.pdf" target="_blank">Tutorial: Changing the StockTrader 5.0 Configuration and Using ConfigWeb</a>
        </li>
        <li>
        <a href="documentation/ConfigServiceVSTemplate.pdf" target="_blank">Using the Visual Studio Template/Implementing Configuration Service 5.0 and the StockTrader 5.0 Design Pattern</a>
        </li>
        <li>
        <a href="documentation/ConfigServiceTechnicalGuide.pdf" target="_blank">Configuration Service 5.0 Technical Guide</a>
        </li>
        </ul>
        ...
        <ul>
        <li>
        <a href="documentation/WindowsAzure.ppsx" target="_blank">Windows Azure Technical Overview</a>
        </li>
         <li>
        <a href="documentation/SQLAzure.ppsx" target="_blank">SQL Azure Technical Overview</a>
        </li>
        </ul>
        <p>
        Here are some key facts about StockTrader 5.0:
        </p>
        <ul>
        <li>The StockTrader sample can be used against three database types: SQL Server 2008 (all editions); SQL Azure; and Oracle 11g.</li>
        <li>The application is logically partitioned into UI, Business Service (BSL), and Data Access (DAL) tiers. </li>
        <li>The application can be run in remote modes using WCF services, and also be run in "collapsed" mode as a <b>standalone</b> Web Application on-premise or on Azure.</li>
        <li>The ConfigWeb application is used to quickly change the modes (remote, or in-process for collapsed mode) the Web Tier, Business Service Layer, and Order Processor 
            use to operate.</li>
            <li>For on-premise deployments, the Configuration Service allows you to scale-out 
                the BSL and OPS service tiers across many nodes without setting up a hardware or 
                software load balancer. Just start a new host on a new node, and it joins the 
                cluster.&nbsp; This has been shown in conjunction with System Center Virtual 
                Machine Manager 2012 as part of an elastic &#39;private cloud.&#39;&nbsp; The Web app 
                and middle tier services also, of course, can work with hardware and software 
                load balancers.</li>
        ...
        This smart client desktop application can connect up to the StockTrader Busniess Services on-premise, or running in the Windows Azure cloud. Check it out as just one example of a hybrid cloud application.
            ...
            <li>The live hosted version on Windows Azure shows another hybrid deployment 
                possibility, with the Web app in the public cloud but all Business Services and 
                the StockTrader Database running in a private, on-premise data center. 
                This is achieved using secure WCF services in conjunction with Microsoft 
                ForeFront 2010 Threat Management Gateway (TMG) and an on-premise DMZ/secure data 
                center.</li>
            <li>There are three core Microsoft technologies for creating hybrid cloud solutions 
                at the application layer: <b><a href="http://msdn.microsoft.com/en-us/netframework/aa663324.aspx" target="_blank">Secure WCF Services</a></b> as shown with StockTrader 5.0; 
