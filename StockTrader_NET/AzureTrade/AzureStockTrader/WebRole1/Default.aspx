...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <ul>
        <li style="text-align: left"><a href="login.aspx">
            ...
            <li><a href="Documentation/Trade5Overview.pdf" target="_blank">StockTrader 5 Technical Overview</a></li>
       
        <li style="text-align: left">
            <a href="Documentation/StockTraderOverview.ppsx"  target="_blank">Slideshow Presentation</a></li>
            <li style="text-align: left">
            <a href="Documentation/stocktraderconfiguration.pdf"  target="_blank">Step-by-Step Configuration Guide</a></li>
