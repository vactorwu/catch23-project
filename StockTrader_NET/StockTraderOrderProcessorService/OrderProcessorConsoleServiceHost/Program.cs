...
//======================================================================================================
// This is one of two optional host programs for the Order Processor Service .  In this case a Console  
    ...
    class OrderProcessor_ConsoleHost
    {
        ...
        class MyHost : ShellServiceConsoleBase
        {
            ...
            public void startUp()
            {
                ...
                base.startService(new Settings(), new ConfigurationService(), new NodeCommunication(), null, new ConfigurationActions(), startupList, endpointBehaviorList, new object[] { typeof(IOrderProcessor) });
            }
        }
