...
//======================================================================================================
// The OrderProcessor WindowsConsole program, which just inherits from the provided class, so is quite
...
namespace Trade.OrderProcessorServiceHost
{
    ...
    /// </summary>
    public class OrderProcessorServiceConsole : ServiceConsoleBase
    {
        /// <summary>
        ...
        private void InitializeComponent() 
        {
            ...
            this.Name = "OrderProcessorServiceConsole";
