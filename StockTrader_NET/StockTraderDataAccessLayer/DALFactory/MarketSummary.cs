...
//======================================================================================================
// The Factory class that returns an instance of the MarketSummary Data Access Class, part of the Data Access 
   ...
   public sealed class MarketSummary
    {
        public static Trade.IDAL.IMarketSummary Create(string path)
        {
            ...
            return (Trade.IDAL.IMarketSummary)Assembly.Load(path).CreateInstance(className);
        }
    }
}
