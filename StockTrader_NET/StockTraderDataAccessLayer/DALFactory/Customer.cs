...
//======================================================================================================
// The Factory class that returns an instance of the Customer Data Access Class, part of the Data Access 
...
namespace Trade.DALFactory
{
    public sealed class Customer
    {
        ...
        public static Trade.IDAL.ICustomer Create(string path)
        {
            ...
            return (Trade.IDAL.ICustomer)Assembly.Load(path).CreateInstance(className);
        }
    }
}
