...
public partial class SiteMaster : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Logo.ImageUrl = "~/Images/dotnetlogo-left.png";
            Logo.PostBackUrl = "http://msdn.microsoft.com/en-us/netframework/";
            NavigationMenu.Items[8].NavigateUrl = "http://" + HttpContext.Current.Server.MachineName + "/" + Settings.PAGE_PATH_CONFIG;
        }
        else
        {
            Logo.ImageUrl = "~/Images/azurestocktrader-logoleft.png";
            Logo.PostBackUrl = "http://www.microsoft.com/windowsazure/windowsazure/";
            NavigationMenu.Items[8].NavigateUrl = "https://azureconfigweb.cloudapp.net/";
        }
    }
}
