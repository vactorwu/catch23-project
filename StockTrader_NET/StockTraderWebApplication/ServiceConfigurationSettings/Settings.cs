...
//======================================================================================================
// The Settings class for the StockTrader Web Application.  Please note well that we only override the
// inherited settings (with the new keyword) becuase of the special case StockTrader allows for running
// BSL in-process with the StockTrader Composite Web Application, vs. remote calls.  You will NOT need to 
// do this for your services--your Settings class will be much simpler, simply using the *inherited* 
// global settings, and only specifying app-specific settings here.  
//======================================================================================================
...
namespace Trade.StockTraderWebApplicationSettings
{
    ...
    /// StockTrader 5 Web Application AND OTHER STOCKTRADER 5 COMPONENTS ARE SPECIAL in that they can collapse down to run within the calling service process.
    ...
    public class Settings : ConfigurationSettingsBase   //Inherit but override from base implementation!!
    {
        ...
        public static string BSL_CLIENT_CONNECTED_SERVICE_CONTRACT;
        ...
        //Only necessary to support in-process AccessMode=InProcess.
        
        public static string BSL_CONFIGDB_SQL_CONN_STRING;

        public static readonly string CACHE_KEY_CLOSED_ORDERSALERT = "O";
        public static string BSL_CLIENT_ACTIVE_SERVICE_HOST_IDENTIFIER = "";
        ...
        public static readonly string PAGE_ACCOUNT = "Account.aspx";
        ...
        public static readonly string PAGE_PORTFOLIO = "Portfolio.aspx";
        ...
        public static readonly string UPARROWLINK =  "<img style=\"width:12px;height:12px\" alt=\"\" src=\"images/arrowup.png\"/>";
        public static readonly string DOWNARROWLINK = "<img style=\"width:12px;height:12px\" alt=\"\" src=\"images/arrowdown.png\"/>";
